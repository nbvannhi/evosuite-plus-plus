...
public class EvoLLM<T extends Chromosome> extends AbstractMOSA<T> {

    private static final long serialVersionUID = -1267042940991321480L;

    private static final Logger logger = LoggerFactory.getLogger(EvoLLM.class);
     ...
     */
    public EvoLLM(ChromosomeFactory<T> factory) {
        super(factory);
    ...
    public void generateSolution() {
        ...
        LoggingUtils.getEvoLogger().info("* Initial number of goals in EvoLLM = "
